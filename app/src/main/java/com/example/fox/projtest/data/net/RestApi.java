...
public interface RestApi {
    ...
    @GET("https://api.flickr.com/services/rest/?method=flickr.photos.getRecent&format=json&nojsoncallback=1&extras=url_z&api_key=f0e6fbb5fdf1f3842294a1d21f84e8a6&per_page=100&page=1")
